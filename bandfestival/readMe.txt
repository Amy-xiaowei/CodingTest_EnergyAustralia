...
About the code, I use Tomcat(8.5)+Maven+Spring MVC to implement the coding test, and export the project to bandfestival.war. Please deploy the bandfestival.war to your Tomcat, or you can import  the project bandfestival to your Eclipse, and also use Tomcat.
